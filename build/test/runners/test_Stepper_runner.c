...
extern void test_iterateCycleCounter_stepsPerMin_is_80000(void);
extern void test_iterateCycleCounter_stepsPerMin_is_100(void);
...
int main(void)
{
  ...
  RUN_TEST(test_blockConfig_StepX_is_100_StepY_is_75_StepZ_is_10_the_StepX_is_largest, 588);
  RUN_TEST(test_blockConfig_StepX_is_100_StepY_is_300_StepZ_is_200_StepY_is_largest, 598);
  RUN_TEST(test_blockConfig_StepX_is_100_StepY_is_300_StepZ_is_1000_StepZ_is_largest, 608);
  RUN_TEST(test_motorRateControlProcess_when_motor_moving_step_is_finish_the_current_block_will_be_discarded, 620);
  RUN_TEST(test_setTickPerStepEventToTimer_if_cycle_15000000_the_actual_cycle_is_58593_and_prescale_is_256, 633);
  RUN_TEST(test_setTickPerStepEventToTimer_if_cycle_72000000_the_actual_cycle_is_35156_and_prescale_is_2047, 639);
  RUN_TEST(test_setTickPerStepEventToTimer_if_cycle_50000_the_actual_cycle_is_50000_and_prescale_is_0, 645);
  RUN_TEST(test_setTickPerStepEventToTimer_if_cycle_1_the_actual_cycle_is_1_and_prescale_is_0, 651);
  RUN_TEST(test_setStepEventPerMin_the_steps_per_min_is_80000_the_cycle_will_be_54000, 657);
  RUN_TEST(test_setStepEventPerMin_the_steps_per_min_is_100_less_than_800_and_steps_per_min_will_become_800, 664);
  RUN_TEST(test_iterateCycleCounter_stepsPerMin_is_80000, 672);
  RUN_TEST(test_iterateCycleCounter_stepsPerMin_is_100, 688);
